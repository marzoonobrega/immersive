$(document).ready(function() {
  ...
  $('#login-input').keypress(function(e) {
    if(e.which === 13 && $(this).val() != '') {
      ...
      setTimeout(function(){
        $('span').remove();
        $('#terminal').append('<br><div>F Society [version 2.0.0].<br> FSociety is a secrect society set up to make the world a better place.<br><br>' + player_name + ' authenticated.<br>We need your help to hack into the mobile of Terry Colby.<br>Use the help command for a list of commands.<br><br><span id="initial-root">$</span>&nbsp;&nbsp;&nbsp;<span id="blinking">_</span></div>');
      }, 6500);
          ...
          if(e.which === 13 && $(this).val() != '' && able === 1) {
            ...
            switch( $(this).val() ) {
              case 'help':
                ...
                window.open('flashback.html', '_blank');
                help = 1;
                break;
              ...
              case 'disconnect':
                if (connect === 1) {
                  ...
                  window.open('disconnect.html', '_blank');
                  disconnect = 1;
                  connect = 0;
                  minutes = 0;
                  seconds = 0;
              ...
              case 'exit':
                ...
                $('#objectives').animate({'opacity': '0'}, 1000);
                $('#time').animate({'opacity': '0'}, 1000);
                window.open('trailer.html', '_blank');
